    ...
    <main id="site_main">
      ...
      <div class="cards">
        <div class="container">
         ...
         <div class="card">
           <img width="50" src="../assets/buy-comics-merchandise.png" alt="mini immagine maglietta bianca">
           <p>DC MERCHANDISE</p>
         </div>
         <div class="card">
           <img width="50" src="../assets/buy-comics-subscriptions.png" alt="mini card bianca con simbolo fulmine">
           <p>SUBSCRIPTION</p>
         </div>
         <div class="card">
